...
const allMachinesRaw: Array<Omit<Machine, 'category'> & { category?: string }> = [
  ...
  },
  {
    ...
    specs: {
      ...
      features: 'Boom Suspension, Comfort Drive Control, fresh 500-hr service, full inspection report',
      status: 'In stock – ships worldwide',
    },
    gallery: [
  ...
  // ========== DECEMBER 2024 BATCH - 10 NEW MACHINES ==========
  {
    ...
    specs: {
      engine: 'Bobcat 3.4L Turbocharged Diesel (Tier 4 Final)',
      power: '92 hp (68.6 kW) @ 2,600 rpm',
      weight: '10,327 lb (4,684 kg) operating weight',
      ratedOperatingCapacity: '3,475 lb (1,576 kg) @ 50% tipping',
      tippingLoad: '6,950 lb (3,153 kg)',
      bucketCapacity: '0.67 yd³ (0.51 m³)',
      liftHeight: '10 ft 6 in (3.20 m) hinge pin',
      breakoutForce: '8,485 lbf (37.7 kN)',
      travelSpeed: '7.1 / 11.4 mph (11.4 / 18.3 km/h) 2-speed',
      trackWidth: '17.7 in (450 mm)',
      groundPressure: '4.2 psi (29.0 kPa)',
      hydraulicFlow: '27.4 gpm (103.7 L/min) standard',
      fuelTank: '27 gal (102 L)',
  ...
  },
  {
    ...
    specs: {
      engine: 'Cat C3.3B Tier 4 Final',
      power: '74.3 hp (55.4 kW) gross',
      weight: '9,039 lb (4,100 kg) operating weight',
      ratedOperatingCapacity: '2,010 lb (912 kg) @ 35% tipping',
      tippingLoad: '5,743 lb (2,605 kg)',
      bucketCapacity: '0.50 yd³ (0.38 m³)',
      liftHeight: '10 ft 2 in (3.10 m) hinge pin',
      breakoutForce: '6,744 lbf (30 kN)',
      travelSpeed: '7.3 mph (11.8 km/h) 2-speed',
      trackWidth: '15.7 in (400 mm)',
      groundPressure: '4.3 psi (29.6 kPa)',
      hydraulicFlow: '23.9 gpm (90.5 L/min) standard',
      fuelTank: '24 gal (91 L)',
      cab: 'Enclosed ROPS/FOPS cab, heat/AC, suspension seat',
  ...
  },
  {
    ...
    specs: {
      engine: 'Kubota V3800-TIEF4 Tier 4 Final',
      power: '96.4 hp (71.9 kW) gross / 87 hp (64.9 kW) net',
      displacement: '3,769 cc (230 cu in)',
      weight: '12,566 lb (5,700 kg) operating weight',
      ratedOperatingCapacity: '2,662 kg (5,870 lb) @ 50% tipping',
      tippingLoad: '5,324 kg (11,738 lb)',
      bucketCapacity: '0.72 yd³ (0.55 m³)',
      breakoutForce: '3,611 kgf (7,961 lbf)',
      liftHeight: '3,200 mm (10 ft 6 in) hinge pin',
      travelSpeed: '7.4 mph (11.9 km/h) 2-speed',
      trackWidth: '17.7 in (450 mm)',
      groundPressure: '4.5 psi (31 kPa)',
      hydraulicFlow: '40.2 gpm (152 L/min) high-flow',
  ...
  },
  {
    ...
    specs: {
      engine: 'Yanmar 4TNV98C Tier 4 Final',
      power: '100 hp (74.6 kW) gross / 96.6 hp (72.0 kW) net',
      weight: '12,100 lb (5,493 kg) operating weight',
      ratedOperatingCapacity: '3,700 lb (1,680 kg) @ 50% tipping',
      tippingLoad: '7,400 lb (3,357 kg)',
      bucketCapacity: '0.78 yd³ (0.60 m³)',
      liftHeight: '10 ft 9 in (3.28 m) hinge pin',
      breakoutForce: '10,178 lbf (45.3 kN)',
      travelSpeed: '7.5 / 11.5 mph (12.1 / 18.5 km/h) 2-speed',
      trackWidth: '17.7 in (450 mm)',
      groundPressure: '4.6 psi (31.7 kPa)',
      hydraulicFlow: '35.2 gpm (133.3 L/min) high-flow',
      fuelTank: '37.5 gal (142 L)',
  ...
  },
  {
    ...
    specs: {
      ...
      power: '74.3 hp (55.4 kW) gross / 73.2 hp (54.6 kW) net',
      displacement: '3,331 cc (203 cu in)',
      weight: '10,384 lb (4,710 kg) operating weight',
      ratedOperatingCapacity: '2,690 lb (1,220 kg) @ 50% tipping',
      tippingLoad: '5,380 lb (2,440 kg)',
      bucketCapacity: '0.56 yd³ (0.43 m³)',
      breakoutForce: '2,920 kgf (6,438 lbf)',
      liftHeight: '3,090 mm (10 ft 2 in) hinge pin',
      travelSpeed: '7.2 mph (11.6 km/h) 2-speed',
      trackWidth: '15.7 in (400 mm) wide',
      groundPressure: '4.8 psi (33.1 kPa) wide track',
      hydraulicFlow: '24.9 gpm (94.3 L/min) standard',
      fuelTank: '25.7 gal (97.3 L)',
      cab: 'Enclosed ROPS/FOPS cab, heat/AC, suspension seat, large door opening',
      features: 'Vertical lift path, 7-inch LCD touchscreen, keyless start, 2-speed travel, rear camera, LED work lights',
  ...
  },
  {
    ...
    isHotOffer: true,
    description: 'Pristine 2024 Kubota SVL75-3 compact track loader with extremely low hours. Kubota V3307-TE5A Tier 4/Stage 5 engine delivers 74.3 hp. Features vertical lift path, high-flow hydraulics, one-piece pressurized cabin with AC/heat, 7-inch touchscreen, and excellent all-around visibility. Essentially new condition for professional contractors.',
    specs: {
      engine: 'Kubota V3307-TE5A-CTL-Q Tier 4/Stage 5',
      power: '74.3 hp (55.4 kW) gross / 73.2 hp (54.6 kW) net',
      displacement: '3,331 cc (203 cu in)',
      ...
      features: 'Vertical lift path, high-flow, 7-inch touchscreen, keyless start, 2-speed, rear camera, LED lights, warranty remaining',
  ...
  },
  {
    ...
    discount: 0,
    category: 'excavators',
    image: bobcatE50_2021_2,
    description: 'Well-maintained 2021 Bobcat E50 compact excavator with 1,890 hours. Powered by a Bobcat diesel engine delivering 48 hp. Features zero-tail swing design, retractable undercarriage (71-89 in), enclosed cab with heat/AC, and excellent visibility. Perfect for residential construction, landscaping, and utility work.',
    specs: {
      engine: 'Bobcat/Kubota D902-E3 Diesel (Tier 4 Final)',
      power: '48 hp (35.8 kW) @ 2,200 rpm',
      weight: '10,500 lb (4,763 kg) operating weight',
      maxDiggingDepth: '12 ft 10 in (3.91 m)',
      maxReach: '18 ft 7 in (5.66 m) at ground level',
      maxDumpingHeight: '12 ft 4 in (3.76 m)',
      bucketDiggingForce: '10,000 lbf (44.5 kN)',
      armDiggingForce: '6,800 lbf (30.2 kN)',
      swingSpeed: '10.5 rpm',
      travelSpeed: '3.5 mph (5.6 km/h)',
      tailSwing: 'Zero tail swing',
      trackWidth: '15.7 in (400 mm)',
      hydraulicFlow: '23 gpm (87 L/min) auxiliary',
      fuelTank: '17.2 gal (65.1 L)',
      transportDimensions: 'Width: 71-89 in (retractable)',
      cab: 'Enclosed ROPS/FOPS cab, heat/AC, suspension seat',
      features: 'Zero tail swing, retractable undercarriage, quick-coupler ready',
      status: 'In stock – work ready',
    },
    gallery: [
      bobcatE50_2021_2,
  ...
  },
  {
    ...
    specs: {
      engine: 'Kubota V2607-CR-TE4 Tier 4 Final',
      power: '40.4 hp (30.1 kW) @ 2,400 rpm',
      weight: '9,447 lb (4,285 kg) operating weight',
      maxDiggingDepth: '11 ft 4 in (3.45 m)',
      maxReach: '18 ft 4 in (5.59 m) at ground level',
      maxDumpingHeight: '12 ft 1 in (3.68 m)',
      bucketCapacity: '0.09 - 0.28 yd³ (0.07 - 0.21 m³)',
      ...
      trackWidth: '15.7 in (400 mm) rubber',
      hydraulicFlow: '17.4 gpm (65.9 L/min) auxiliary',
      fuelTank: '15.9 gal (60 L)',
      cab: 'Enclosed ROPS/FOPS cab, heat/AC, suspension seat',
      features: 'Quick-coupler, angle blade with float, LED work lights, pattern changer',
      status: 'In stock – excellent condition',
    },
    gallery: [
  ...
  },
  {
    ...
    description: 'Low-hour 2022 Kubota KX057-5 mini excavator with only 1,089 hours. Kubota V2607 Tier 4 Final engine produces 47.6 hp (gross) / 46.4 hp (net). Features enclosed deluxe cab with AC/heat, pattern changer, and proportional auxiliary hydraulics. Excellent for utility, landscaping, and construction applications.',
    specs: {
      engine: 'Kubota V2607-CR-E5-BH1 Tier 4 Final',
      power: '47.6 hp (35.5 kW) gross / 46.4 hp (34.6 kW) net @ 2,200 rpm',
      displacement: '159.6 cu in (2,615 cc)',
      weight: '12,346 lb (5,600 kg) rubber / 12,577 lb (5,705 kg) steel',
      maxDiggingDepth: '12 ft 9 in (3.88 m)',
      maxReach: '20 ft 1 in (6.13 m) at ground level',
      maxDumpingHeight: '13 ft 8 in (4.16 m)',
      bucketCapacity: '0.21 yd³ (0.16 m³)',
      bucketDiggingForce: '10,172 lbf (46.1 kN)',
      armDiggingForce: '5,463 lbf (24.8 kN)',
      swingSpeed: '9.2 rpm',
      travelSpeed: '1.7 / 3.0 mph (2.8 / 4.8 km/h) 2-speed',
      tailSwing: '6 ft 6 in (1.99 m) turning radius',
      trackWidth: '15.7 in (400 mm) rubber / 17.3 in (440 mm) steel',
      hydraulicFlow: '14.8 gpm (56.1 L/min) variable × 2',
      fuelTank: '19.3 gal (73 L)',
      cab: 'Enclosed deluxe cab, heat/AC, pattern changer, suspension seat',
      features: '4-way blade, proportional aux hydraulics, LED lights, 70° boom swing',
      status: 'In stock – low hours, excellent condition',
    },
    gallery: [
      kubotaKx0575_2022_1,
  ...
  },
  {
    ...
    specs: {
      ...
      weight: '8,135 lb (3,690 kg) operating weight',
      maxDiggingDepth: '10 ft 0 in (3.06 m)',
      maxReach: '16 ft 7 in (5.05 m) at ground level',
      maxDumpingHeight: '10 ft 6 in (3.20 m)',
      bucketCapacity: '0.09 yd³ (0.07 m³)',
      bucketDiggingForce: '5,952 lbf (26.5 kN)',
      armDiggingForce: '3,148 lbf (14.0 kN)',
      swingSpeed: '9.5 rpm',
      travelSpeed: '2.7 mph (4.3 km/h)',
      tailSwing: 'Conventional swing',
      trackWidth: '11.8 in (300 mm) rubber',
      hydraulicFlow: '14.5 gpm (55 L/min)',
      fuelTank: '10.6 gal (40 L)',
      cab: 'Enclosed ROPS/FOPS cab, heat/AC, suspension seat',
      features: 'Mechanical quick coupler, backfill blade, LED work lights, factory warranty',
      status: 'In stock – nearly new, factory warranty',
    },
    gallery: [
      deere35pTier2025_1,
      deere35pTier2025_2,
